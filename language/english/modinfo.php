...
// v2.30
define('_MI_XFGB_FLAGDIR', 'Repertoire of the images: <span style="color: #FF0000; ">do not modify</span>');
...
//Help
define('_MI_XFGB_DIRNAME', basename(dirname(dirname(__DIR__))));
define('_MI_XFGB_HELP_HEADER', __DIR__ . '/help/helpheader.html');
define('_MI_XFGB_BACK_2_ADMIN', 'Back to Administration of ');
define('_MI_XFGB_HELP_OVERVIEW', 'Overview');
